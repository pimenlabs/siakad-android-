...
public class DetailRangkingActivity extends ListActivity {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			kode = b.getString("kodeangk");
	        
	        JSONParser jParser = new JSONParser();
	        String link_url = "http://10.0.2.2/siakad-andro/detail-rangking.php?kode="+kode;
			...
			try {
				...
				for(int i = 0; i < str_login.length(); i++){
					...
					String nama = i+1+". "+ar.getString("nama")+" - "+ar.getString("nilai");
		...
		public void adapter_listview() {
			...
			ListAdapter adapter = new SimpleAdapter(this, angkatan,R.layout.list_item,new String[] { "nama", "kodeangk"}, new int[] {R.id.tangk, R.id.kodeangk});
