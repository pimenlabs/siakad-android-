...
public class InfoKampusActivity extends ListActivity {
		...
		public void onCreate(Bundle savedInstanceState) {
	        ...
	        String link_url = "http://10.0.2.2/siakad-andro/info.php";
